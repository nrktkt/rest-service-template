...
package object util {
  ...
  implicit def readsUnmarshaller[A](implicit reads: Reads[A]) = Unmarshaller[JsValue, A](_ => js =>
  ...
  implicit val jsonUnmarshaller: FromEntityUnmarshaller[JsValue] = PredefinedFromEntityUnmarshallers
